...
namespace org.livz.EvernoteAPIWrapper
{
    ...
    public class NoteService
    {
        ...
        /// <returns></returns>
        public IList<NoteModel> GetNotes(string authToken, Guid notebookid, long? timestamp, out long newtimestamp, TextResolver resolver = TextResolver.basic)
        {
            // initialize
            newtimestamp = 0;
            ...
            NotesMetadataList newNotes = _Instance.findNotesMetadata(authToken, filter, pageNumber * pageSize, pageSize, resultSpec);
            ...
            foreach (NoteMetadata note in newNotes.Notes)
            {
                ...
                string content = _Instance.getNoteContent(authToken, note.Guid);
